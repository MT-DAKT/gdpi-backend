    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrateur'), ('resp_it', 'Responsable IT'), ('technicien', 'Technicien'), ('utilisateur', 'Utilisateur final')], default='utilisateur', max_length=20, verbose_name='Rôle')),
